...
## Capstone_1 exercises breakdown by day
1. [Day_1: Import and clean data](capstone_exercises/capstone_1_day_1/index.qmd){target="_blank"}
	- Import data ENR, ADM, Allocation, Violation data.
