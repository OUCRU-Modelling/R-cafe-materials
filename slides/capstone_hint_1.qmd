...
# Define file path
daily_file_path <- file.path("data", "2-10-2020-_03TS_V1_Data.xls")
...
```{r}
allocation_file_path <- file.path("data", "03TS_Randlist.xlsx")
...
```{r}
violations_file_path <- file.path("data", "Protocol violations, exclusions, withdrawals.xlsx")  
