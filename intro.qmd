...
**Github Desktop** is an application that allows users to `push` their changes from local changes to Github

## Git and Github {auto-animate="true"}

push, pull, commit, branch

## Clone R-cafe repository {auto-animate="true"}

R-cafe repo: <https://github.com/OUCRU-Modelling/R-cafe>
...
::: medium-text-size
***Exercise:*** Create a function that allow users to choose compute basic statistics for number cases of each country.
...
Read the code and guess the answer for 3 Questions below
...
arg  
# refers to global variabl example_var here 
paste0("Value of variable example_var ", example_var)
```
...
{{< downloadthis data/linelisting_raw.xlsx dname="linelisting_raw" label="linelisting_raw.xlsx" type=light >}}
